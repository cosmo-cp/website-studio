                ...
                >
                    ...
                    <div className="flex h-[400px] md:h-[600px]" ref={ref}>
                        ...
                        <div className="w-64 border-r border-white/10 bg-white/5 hidden md:flex flex-col p-4">
                            ...
                            <div
                                className="text-xs font-medium text-muted-foreground/50 px-2 mb-3 uppercase tracking-wider">
                                Recent
                            </div>
                        ...
                        <div className="flex-1 p-6 flex flex-col min-h-0">
                            <div
                                className="flex-1 space-y-6 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                                {/* Previous Chat History (Faded) */}
                                <div className="flex justify-end opacity-40">
                                    <div
                                        className="bg-primary/20 text-foreground px-4 py-2 rounded-2xl rounded-tr-sm max-w-[80%] text-sm">
                                ...
                                <div className="flex justify-start opacity-40">
                                    <div
                                        className="bg-muted/50 px-4 py-2 rounded-2xl rounded-tl-sm max-w-[80%] text-sm">
                                ...
                                >
                                    <div
                                        className="bg-primary text-primary-foreground px-4 py-2 rounded-2xl rounded-tr-sm max-w-[80%] shadow-lg">
                                        {concept.question}
                                    </div>
                                </motion.div>
