...
This guide walks you through the fastest way to get Cosmo Studio running and connected to your preferred model provider.
...
5. Choose a provider (OpenAI, Anthropic, Google, or Ollama).
